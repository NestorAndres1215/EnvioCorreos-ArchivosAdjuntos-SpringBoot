...
const enviarFormulario = async () => {
    ...
    try {
        ...
        const response = await axios.post(
            "http://localhost:8080/contacto/enviar",
            formData
        )
    ...
    <div class="page">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <h2 class="title">Envíanos un<br><span class="title-accent">mensaje</span></h2>
            ...
            <form @submit.prevent="enviarFormulario" class="form">
                ...
                <div class="field">
                    <label>Asunto</label>
                    <input v-model="asunto" placeholder="¿De qué trata tu mensaje?" required />
                </div>

                <div class="field">
                    <label>Mensaje</label>
                    <textarea v-model="mensaje" placeholder="Escribe tu mensaje aquí..." rows="5" required></textarea>
                </div>
                ...
                <div class="field">
                    ...
                    <label class="file-drop" :class="{ 'has-file': archivoNombre }">
                        ...
                        <span class="file-text">{{ archivoNombre || 'Haz clic para adjuntar un archivo' }}</span>
                    </label>
                </div>

                <button type="submit" class="submit-btn" :disabled="estado === 'loading'">
...
.submit-btn {
    ...
    box-shadow: 0 0 0 1px rgba(99, 102, 241, 0.4), 0 16px 36px rgba(99, 102, 241, 0.3);
    margin-top: 4px;
}

.submit-btn:hover:not(:disabled) {
    transform: translateY(-2px);
    box-shadow: 0 0 0 1px rgba(99, 102, 241, 0.6), 0 24px 48px rgba(99, 102, 241, 0.4);
}
